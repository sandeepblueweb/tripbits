              ...
              <nav className="navbar navbar-expand-md navbar-light">
                ...
                >
                  ...
                  <ul className="navbar-nav">
                    ...
                    <li className="nav-item"><Link to='#' className="nav-link active">Manage Bookings</Link></li>
                    <li className="nav-item"><Link to='#' className="nav-link active">Select Language</Link></li>
                  </ul>
                  <div className="others-options d-flex align-items-center">
                    ...
                    {/* <div className="option-item">
                      <select name="" id="">
                        <option value="">Select your language direction</option>
